...
/**
 * UI Automation data reader
 * Please do not modify or if needed kindly communicate with the author
 * @author alexander.pangilinan
 *
 */
public class csvMobileDataProvider implements Iterator<Object[]> {

    protected static final Logger LOGGER = mobileEnvironment.getlog();
    ...
    public static Iterator getDataProvider(Class cls, Method method) throws IOException {
        ...
        return new csvMobileDataProvider(method);
    }
    ...
    public csvMobileDataProvider(Method method) throws IOException {
